...
| `test_motor_dynamics` | Brushed DC submodule integration and motor-to-vehicle composition. | Motor parameters, DC bus command, load torque. | Analytic speed convergence, vehicle response, and fail-closed invalid command. |
