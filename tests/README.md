...
| `test_motor_dynamics` | Compose DC and BLDC actuator commands, `motorDynamics` shaft state, and the vehicle rotor input. | Brushed DC and six-step BLDC fixtures | DC equilibrium, BLDC-to-vehicle response, and fail-closed command contracts. |
