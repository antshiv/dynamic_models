...
| `test_motor_dynamics` | Compose normalized actuator command, `motorDynamics` shaft state, and the vehicle rotor input. | Brushed DC fixture | Converges to the analytic speed and produces a vehicle force response. |
